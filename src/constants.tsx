...
export const UserGroupIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-slate-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.653-.124-1.274-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.653.124-1.274.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
    </svg>
);
...
export const ShieldCheckIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className || "h-8 w-8 text-slate-500"} fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
...
export const NeuronIcon = ({ className }: { className?: string }) => (
    <svg 
    ...
    >
        ...
        <path d="M12 9.5A2.5 2.5 0 0 1 9.5 7"/>
        <path d="M12 9.5A2.5 2.5 0 0 0 9.5 7"/>
        <path d="M14.5 16a2.5 2.5 0 0 1-2.5 2.5"/>
